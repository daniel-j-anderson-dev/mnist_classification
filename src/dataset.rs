...
mod test {
    use crate::dataset::{
        get_test_image, get_training_image, IMAGES_MAGIC_NUMBER, IMAGE_HEIGHT, IMAGE_WIDTH,
        LABELS_MAGIC_NUMBER, TEST_IMAGES, TEST_IMAGE_COUNT, TEST_LABELS, TRAINING_IMAGES,
        TRAINING_IMAGE_COUNT, TRAINING_LABELS,
    };
